-- Frozen from PR16 main 91e737a06e11773858d732c326c58d1bca1d18b2; generated by its runtime.
...
CREATE TABLE ops_document_versions(tenant_id TEXT NOT NULL,document_id TEXT NOT NULL,revision INTEGER NOT NULL,content TEXT NOT NULL,content_hash TEXT NOT NULL,status TEXT NOT NULL CHECK(status IN ('draft','review','approved','rejected')),decided_by TEXT,decision_note TEXT,decided_at TEXT, context_json TEXT, context_hash TEXT, created_by TEXT, created_at TEXT, approved_by TEXT,PRIMARY KEY(tenant_id,document_id,revision),FOREIGN KEY(tenant_id,document_id) REFERENCES ops_entities(tenant_id,id));
...
INSERT INTO schema_versions_operations VALUES(1,'frozen-v9');
INSERT INTO schema_versions_operations VALUES(2,'frozen-v9');
INSERT INTO schema_versions_operations VALUES(3,'frozen-v9');
INSERT INTO schema_versions_operations VALUES(4,'frozen-v9');
INSERT INTO schema_versions_operations VALUES(5,'frozen-v9');
INSERT INTO schema_versions_operations VALUES(6,'frozen-v9');
INSERT INTO schema_versions_operations VALUES(7,'frozen-v9');
INSERT INTO schema_versions_operations VALUES(8,'frozen-v9');
INSERT INTO schema_versions_operations VALUES(9,'frozen-v9');
