...
Odbiór P08a2 wymaga jeszcze CI, próby dwóch firm i równoległych projektów w Chrome/API, restore oraz scalenia i aktualizacji głównej instalacji. Brak dokumentów P09a i pełnego onboardingu P06 pozostaje jawny.
